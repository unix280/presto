...
public class TestFlightShimPluginManager
{
    ...
    {
        assertEquals(FlightShimPluginManager.substitutePlaceHolder(propertyValue, MOCKED_ENV), expectedSubstitutedValue);
    }
    ...
    {
        FlightShimPluginManager.substitutePlaceHolder(propertyValue, MOCKED_ENV);
    }
}
