...
public interface GovernancePolicyStrategy
{
    default List<GovernPolicyFormat> getGovernancePolicy(QueryBasicInfo queryBasicInfo, String catalog, String schema, Identity identity)
    {
        return null;
    }
}
