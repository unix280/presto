...
public class StandardQueryAuditAndGovernance
        implements QueryAuditAndGovernance
{
    public static final String NAME = "standard";
    private static final StandardQueryAuditAndGovernance INSTANCE = new StandardQueryAuditAndGovernance();
    ...
    /**
     * This method is the implementation of governquery method for the governance type - standard
     *
     * @param preparedQuery
     * @param query
     * @param catalog
    ...
    public String governquery(PreparedQuery preparedQuery, String query, String catalog, String schema, Identity identity)
    {
        ...
        if (preparedQuery instanceof BuiltInQueryPreparer.BuiltInPreparedQuery && null != ((BuiltInQueryPreparer.BuiltInPreparedQuery) preparedQuery).getWrappedStatement()) {
            ...
            if (wrappedStatement instanceof Query) {
                ...
                QueryRewriteApplicableResponse queryRewriteApplicableResponse = governanceUtil.isQueryReWriteRequired(((BuiltInQueryPreparer.BuiltInPreparedQuery) preparedQuery).getWrappedStatement(), policyformatList, queryBasicInfo);
