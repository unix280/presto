        ...
        extends SemiTransactionalHiveMetastore
{
    ...
    public static TestingSemiTransactionalHiveMetastore create()
    {
        ...
        ExtendedHiveMetastore delegate = new BridgingHiveMetastore(new ThriftHiveMetastore(hiveCluster, new MetastoreClientConfig(), null), new HivePartitionMutator());
    ...
    @Override
    public synchronized void declareIntentionToWrite(HdfsContext hdfsContext, LocationHandle.WriteMode writeMode, Path stagingPathRoot, Optional<Path> tempPathRoot, String filePrefix, SchemaTableName schemaTableName, boolean temporaryTable)
    {
        throw new UnsupportedOperationException("method not implemented");
    }
