        ...
        extends SemiTransactionalHiveMetastore
{
    ...
    public static TestingSemiTransactionalHiveMetastore create()
    {
        ...
        ExtendedHiveMetastore delegate = new BridgingHiveMetastore(new ThriftHiveMetastore(hiveCluster, new MetastoreClientConfig(), null), new HivePartitionVersionFetcher());
