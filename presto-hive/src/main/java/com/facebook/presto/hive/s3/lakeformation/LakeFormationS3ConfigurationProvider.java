        ...
        implements DynamicConfigurationProvider
{
    ...
    public void updateConfiguration(Configuration configuration, HdfsContext context, URI uri)
    {
        ...
        if (impersonationEnabled) {
            MetastoreContext metastoreContext = new MetastoreContext(context.getIdentity(), context.getQueryId().orElse(""), context.getSession().flatMap(MetastoreUtil::getMetastoreHeaders), HiveColumnConverterProvider.DEFAULT_COLUMN_CONVERTER_PROVIDER);
