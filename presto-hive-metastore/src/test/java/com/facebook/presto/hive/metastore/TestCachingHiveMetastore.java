...
public class TestCachingHiveMetastore
{
    ...
    public void testGetAllDatabases()
    {
        ...
        assertEquals(metastore.getAllDatabases(METASTORE_CONTEXT), ImmutableList.of(TEST_DATABASE));
    ...
    {
        assertEquals(mockClient.getAccessCount(), 0);
        assertEquals(metastore.getAllTables(METASTORE_CONTEXT, TEST_DATABASE).get(), ImmutableList.of(TEST_TABLE));
        assertEquals(mockClient.getAccessCount(), 1);
        assertEquals(metastore.getAllTables(METASTORE_CONTEXT, TEST_DATABASE).get(), ImmutableList.of(TEST_TABLE));
        assertEquals(mockClient.getAccessCount(), 1);
    ...
    {
        assertFalse(metastore.getAllTables(METASTORE_CONTEXT, BAD_DATABASE).isPresent());
    }
    ...
    {
        assertEquals(mockClient.getAccessCount(), 0);
        assertNotNull(metastore.getTable(METASTORE_CONTEXT, TEST_DATABASE, TEST_TABLE));
        assertEquals(mockClient.getAccessCount(), 1);
        assertNotNull(metastore.getTable(METASTORE_CONTEXT, TEST_DATABASE, TEST_TABLE));
        assertEquals(mockClient.getAccessCount(), 1);
    ...
    {
        assertFalse(metastore.getTable(METASTORE_CONTEXT, BAD_DATABASE, TEST_TABLE).isPresent());
    ...
    public void testGetPartitionNamesByParts()
    {
        ...
        assertEquals(mockClient.getAccessCount(), 0);
        assertEquals(metastore.getPartitionNamesByFilter(METASTORE_CONTEXT, TEST_DATABASE, TEST_TABLE, ImmutableMap.of()), expectedPartitions);
        assertEquals(mockClient.getAccessCount(), 1);
        assertEquals(metastore.getPartitionNamesByFilter(METASTORE_CONTEXT, TEST_DATABASE, TEST_TABLE, ImmutableMap.of()), expectedPartitions);
        assertEquals(mockClient.getAccessCount(), 1);
    ...
    {
        assertTrue(metastore.getPartitionNamesByFilter(METASTORE_CONTEXT, BAD_DATABASE, TEST_TABLE, ImmutableMap.of()).isEmpty());
    }
    ...
    {
        Map<String, Optional<Partition>> partitionsByNames = metastore.getPartitionsByNames(METASTORE_CONTEXT, getTableOrElseThrow(), ImmutableList.of(BAD_PARTITION));
    ...
    public void testNoCacheExceptions()
    {
        ...
        try {
            metastore.getAllDatabases(METASTORE_CONTEXT);
        }
