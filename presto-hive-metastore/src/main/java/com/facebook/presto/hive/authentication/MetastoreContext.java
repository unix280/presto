...
public final class MetastoreContext
{
    ...
    public MetastoreContext(ConnectorSession session, Optional<String> metastoreHeaders, ColumnConverterProvider columnConverterProvider)
    {
        this(requireNonNull(session, "session is null").getIdentity(), session.getQueryId(), metastoreHeaders, columnConverterProvider);
    }

    public MetastoreContext(ConnectorIdentity identity, String queryId, Optional<String> metastoreHeaders, ColumnConverterProvider columnConverterProvider)
    {
        this(requireNonNull(identity, "identity is null"), queryId, Optional.empty(), Optional.empty(), metastoreHeaders, false, columnConverterProvider);
    }
