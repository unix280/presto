...
public class GlueSecurityMappings
{
    private final List<GlueSecurityMapping> mappings;

    @JsonCreator
    public GlueSecurityMappings(@JsonProperty("mappings") List<GlueSecurityMapping> mappings)
    {
