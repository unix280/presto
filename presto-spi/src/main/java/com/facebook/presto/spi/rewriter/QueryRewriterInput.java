...
public class QueryRewriterInput
{
    ...
    private final Set<String> gfsEnabledCatalogs;
            ...
            int retryCount)
    {
        ...
        this.gfsEnabledCatalogs = gfsEnabledCatalogs;
    ...
    public Set<String> getGfsEnabledCatalogs()
    {
        return gfsEnabledCatalogs;
    }
    ...
    public static class Builder
    {
        ...
        private Set<String> gfsEnabledCatalogs;
        ...
        public Builder setGfsEnabledCatalogs(Set<String> gfsEnabledCatalogs)
        {
            this.gfsEnabledCatalogs = gfsEnabledCatalogs;
            return this;
        }
