...
public class QueryRewriterOutput
{
    ...
    /**
     * Used for showing the executed query on UI and in logs.
     */
    private final String userVisibleQuery;
    private final Map<String, String> sessionProperties;
    private final RuntimeStats runtimeStats;

    private QueryRewriterOutput(String queryId, String originalQuery, String rewrittenQuery, Map<String, String> sessionProperties, RuntimeStats runtimeStats, String userVisibleQuery)
    {
        ...
        this.userVisibleQuery = userVisibleQuery;
    }

    public String getUserVisibleQuery()
    {
        return userVisibleQuery;
    }
    ...
    public String toString()
    {
        return "QueryRewriterOutput{" +
                ...
                ", userVisibleQuery='" + userVisibleQuery + '\'' +
    ...
    public static class Builder
    {
        ...
        private String userVisibleQuery;
        ...
        public Builder setUserVisibleQuery(String userVisibleQuery)
        {
            this.userVisibleQuery = userVisibleQuery;
            return this;
        }
        ...
        public QueryRewriterOutput build()
        {
            ...
            requireNonNull(userVisibleQuery, "userVisibleQuery is null");
            requireNonNull(queryId, "queryId is null");
            checkArgument(!rewrittenQuery.isEmpty() && !originalQuery.isEmpty() && !queryId.isEmpty());
            return new QueryRewriterOutput(queryId, originalQuery, rewrittenQuery, sessionProperties, runtimeStats, userVisibleQuery);
        }
    }
}
